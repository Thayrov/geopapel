...
const FooterPayments = () => {
    ...
    <Grid templateColumns={{ base: '1fr', md: ' 1fr', lg: 'repeat(2, 1fr)' }} mt={10} gap={0} ml={{base:10, lg:40}} mr={{lg:60}}  pb={{base:20, lg:40}} >
    <GridItem> 
        <Text  
        fontWeight={600}
        ...
        height={{base:20, lg:10}} src={payments}
        width={{md:"90%", lg:"100%"}}>
        </Image>
         <Image 
         mt={4}
        display={{base:"block",md:"none", lg:"none"}}
        height={{base:24, lg:10}} src={paymentsSmall}></Image>
    </GridItem>
